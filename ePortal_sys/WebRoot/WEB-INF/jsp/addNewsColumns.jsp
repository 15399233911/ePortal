	...
	<body>
		...
		<center>
		    ...
		    <div style="margin-top: 150px">
		        <form id="form1" name="form1" method="post" onsubmit="return checkValue()" action="addNewsColumns.action">
		          <table width="400" border="0" align="center">
		            <tr>
		              <th height="45" colspan="3" bgcolor="#999999" scope="col"><h4>新增新闻栏目</h4></th>
		            </tr>
		            <tr>
		              <td width="400" height="45" align="right" bgcolor="#CCCCCC">上级栏目：</td>
		              <td height="45" colspan="2" bgcolor="#CCCCCC">
		              	<label>
		               	  <select name="id" size="1" id="id" style="width:200px">
		                  	<option value="0">无上级类别</option>
							<s:iterator value="list">
		                  	<option value="<s:property value="id"/>"><s:property value="columnname"/></option>
		                  	</s:iterator>
		                  </select>
		              	</label>
		              </td>
		            ...
		            <tr>
		              ...
		              <td height="45" colspan="2" bgcolor="#CCCCCC">
		              	<label>
		           		  <input style="width:195px" type="text" name="columnname" id="columnname" />
		              	</label>
		              </td>
		            </tr>
		            <tr>
		              ...
		              <td height="45" colspan="2" bgcolor="#CCCCCC">
		              	<label>
		           		  <input style="width:195px" type="text" name="columncode" id="columncode" />
		              	</label>
		              </td>
		            </tr>
		            <tr>
